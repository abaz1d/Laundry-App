		...
		<section id="Review">
			<Container>
				<div className="d-flex justify-content-center mb-5">
					<h2 className="text-primary head-title mt-5">Review & Rating</h2>
				</div>
				<Row className="mt-3 mb-5">
					<Col md={4}>
						<div>
							...
							<div className="text-center">
								<h5 className="text-primary mt-4 mb-0">Alberto Duncan</h5>
					...
					<Col md={4}>
						<div>
							...
							<div className="text-center">
								<h5 className="text-primary mt-4 mb-0">Silva de Maria</h5>
					...
					<Col md={4}>
						<div>
							...
							<div className="text-center">
								<h5 className="text-primary mt-4 mb-0">Milton Chapman</h5>
