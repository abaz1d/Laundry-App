...
const OrderAndProcess = () => {
	return (
		<Container>
			<Row className="my-2">
				<Col md={6}>
					<h2 className="text-primary head-title mt-5">How to order</h2>
					...
					<div>
						<h2 className="text-primary head-title mt-3">Terms & Condition</h2>
				...
				<Col md={6} className="mobileView">
					<h2 className="text-primary head-title mt-5 ml-5">Details of Services</h2>
					<p className="text-justify story ml-5">
						Cleanixer help you find laundry service near you and ensure that your clothes ar led by
					...
					<div className="ml-5 my-5">
						<h2 className="text-primary head-title mt-5">FAQ of Our Service</h2>
