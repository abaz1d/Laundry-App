...
const WashAndFold = (props) => {
	...
	return (
		<section id="WashAndIron">
			<Container>
				<div className="row g-3 justify-content-between py-3">
					<div className="col-md-8">
						<h2 className="text-primary">Wash & Fold Service</h2>
					</div>
						...
						<div className={classes.root}>
							<Accordion className="p-2">
								<AccordionSummary
									...
									id="panel1a-header"
								>
									<img src={manDress} alt="Men's Wear" className="mr-3" />
											...
											<div key={item.id}>
												...
												<ListItem>
													<Typography className={classes.secondaryHeading}>
														<span className="price">Rp. {item.price}</span> / pcs
													</Typography>
							...
							<Accordion className="p-2">
								<AccordionSummary
									...
									id="panel2a-header"
								>
									<img src={womanDress} alt="Women's Wear" className="mr-3" />
							...
							<Accordion className="p-2">
								<AccordionSummary
									...
									id="panel3a-header"
								>
									<img src={houseDress} alt="Household & Accessories" className="mr-3" />
