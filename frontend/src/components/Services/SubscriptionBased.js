			...
			<Container>
				<div className="row justify-content-between py-3">
					<div className="col-md-8">
						<h2 className="text-primary">Subscription Based Service</h2>
					</div>
						...
						<div className={classes.root}>
							...
							<Accordion className="p-2">
								<AccordionSummary
									...
									id="panel2a-header"
								>
									<img src={womanDress} alt="Woman Dress" className="mr-3" />
							...
							<Accordion className="p-2">
								<AccordionSummary
									...
									id="panel3a-header"
								>
									<img src={houseDress} alt="House Dress" className="mr-3" />
