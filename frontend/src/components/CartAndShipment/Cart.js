...
const Cart = (props) => {
	...
	return (
		<div className="cartClass" style={{ height: cartHeight }}>
			<h4 className="text-primary d-flex justify-content-center m-2">Your Cart</h4>
			...
			<List className={classes.root}>
					...
					<div key={item.id}>
						...
						<ListItem>
							...
							<Typography className={classes.secondaryHeading}>
								<span className="price">Rp. {item.price * item.quantity}</span>
							</Typography>
						</ListItem>
					</div>
				))}
				...
				<ListItem>
					...
					<ListItemText primary="" />
					<Typography className={classes.secondaryHeading}>
						<span className="price">Rp. {subTotal}</span>
					</Typography>
				</ListItem>
				<ListItem>
					...
					<ListItemText primary="" />
					<Typography className={classes.secondaryHeading}>
						<span className="price">Rp. {deliveryCharge}</span>
					</Typography>
				</ListItem>
				<ListItem>
					...
					<ListItemText primary="" />
					<Typography className={classes.secondaryHeading}>
						<span className="price">Rp. {grandTotal}</span>
					</Typography>
				</ListItem>
			</List>
