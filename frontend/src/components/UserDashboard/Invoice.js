	...
	return (
		<div className="print-container">
			<div className="d-flex justify-content-center mb-4">
				<h2 className="text-primary head-title mt-5">Cleanixer Online Laundry Service</h2>
			</div>
			<div className="row">
			...
			<hr />
			<div className="d-flex justify-content-center mb-4">
				<h3 className="text-primary head-title mt-5">
			...
			<div className="row">
				...
				<div className="col-md-5 mt-5">
					...
					<h4 className="text-dark">
						<i className="now-ui-icons ui-1_email-85" /> clinixer.support@gmail.com
					</h4>
				</div>
			</div>
		</div>
